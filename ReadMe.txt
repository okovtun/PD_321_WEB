...
TODO:
1. Обеспечить возможность изменения дисциплины;
2. Обеспечить возможность добавлять дисциплину для преподавателя;
3. Обеспечить возможность добавлять преподавателя по дисциплине;
	Таблица преподавателей для выбранной дисциплины должна обновляться интерактивно при добавлении преподавателя;
	Решить проблему с изнасилованием первичного ключа;
	Влить ветку 'PHPoptimizeDisciplinePage' в 'PHPoptimisationInDB';
