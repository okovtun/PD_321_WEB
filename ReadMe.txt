...
TODO:
1. На странице Digits реализовать конвертор из Двоичной системы счиления в Десятичную;
2. На странице Digits реализовать конвертор из Двоичной системы счиления в Шестнадцатеричную;
