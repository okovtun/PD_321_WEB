...
2. Для каждого направления отобразить какие дисциплины на нем преподаются, и количество этих дисциплин;
	-----------------------------------------------
3. Обеспечить возможность добавления дисциплины преподавателю:
	...
	- На страницу 'Edit' нкжно добавить кнопку 'Добавить', которая будет добавлять дисциплину выбранному преподавателю;
